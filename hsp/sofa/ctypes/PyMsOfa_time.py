...
from PyMsOfa_basic import lib, c_int4, array_1d_double, vector_double, array_double_2, vector_double2f, vector_double3, pym_msg 
...
#Note: for single byte s, here using c_wchar that can work.  
    ...
    if j > 0:
        ws.warn(pym_msg[j], UserWarning, 2)
    return days.value 
