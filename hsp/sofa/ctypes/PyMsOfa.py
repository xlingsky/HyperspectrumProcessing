...
from ctypes import *
from hsp.sofa.ctypes.PyMsOfa_basic import lib, c_int4, array_1d_double, vector_double, array_double_2, vector_double2f, vector_double3
