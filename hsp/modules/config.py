...
DEFAULT_CFG = {
    ...
    'preprocessing_denoising': False,
    'preprocessing_camera_motion': False,
    'detection_output_postfix': ['_points.txt'],
    ...
    'target_maximum_speed': 20,
    'tracking_output_postfix': ['_points.txt'],
